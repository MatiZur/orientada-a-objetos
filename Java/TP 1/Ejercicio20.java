...
public class Ejercicio20{
	public static void main(String[] args){
		...
		scanner.close();
		String minus = "abcdefghijklmnopqrstuvwxyz";						// String para guardar todas las minúsculas
		String mayus = "ABCDEFGHIJKLMNOPQRSTUVWXYZ";						// String para guardar todas las mayúsculas
		System.out.print("\nContraseña generada: ");
